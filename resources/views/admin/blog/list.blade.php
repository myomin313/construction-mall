...
<div class="quotation-area mg-tb-30">
            <div class="container-fluid">
              ...
              <div class="card">
                ...
                @endphp
                             <!--start-->
                                    <form class="form-inline" action="{{ route('freelancer.blogs') }}" method="get">
                                          {{csrf_field()}}
                                      ...
                                      @if(Auth::user()->role == 4 || Auth::user()->role == 5)
                                         <div class="form-group col-md-3 col-sm-6 col-xs-12" >
                                          ...
                                          <input value="{{$posted_user}}" type="text" class="form-control" name="posted_user" placeholder="Eg.Aung Aung">
                                       </div>
                                     @endif
                                      <div class="form-group col-md-3 col-sm-6 col-xs-12">
                                        <label>Status :</label>
                                      ...
                                      <div class="form-group pull-right col-md-2 col-sm-6 col-xs-12 pt-2em">
                          ...
                          <table id="table" class="table table-bordered">
                                        ...
                                        <tbody>
                                         ...
                                         @foreach($blogs as $blog)
                                            ...
                                            @if(Auth::user()->role == 4 || Auth::user()->role == 5)
                                            <select id="{{$blog->id}}" data-control="status" name="is_active" class="form-control status_change">
