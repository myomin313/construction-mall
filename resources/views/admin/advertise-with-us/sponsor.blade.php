...
@section('content')
                ...
                <div class="row">
                    <div class="col-lg-offest-8 col-md-offset-8 col-sm-4 col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <ol class="breadcrumb pull-right">
                          <li><a href="#">Home</a></li>
                          <li class="#"><a  href="{{ route('news.create') }}"> Create </a></li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="false" data-show-refresh="false" data-key-events="true" data-show-toggle="false" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="creator" data-editable="true">Btn Text</th>  
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td></td>
                                               <td>{{ ($sponsors->currentPage()-1) * $sponsors->perPage() + $loop->index + 1 }}</td>
                                                  <td><img src="{{ asset('storage/setting/'.$sponsor->img) }}" alt="" title="" ></td>
                                                <td><?= $sponsor->title ?></td>
                                                <td><?= $sponsor->description ?></td>
                                                <td><?= $sponsor->btn_text ?></td>
                                                <td>
                                                    <a href="{{ route('advertise-with-us.edit',['id'=>$sponsor->id])}}" class="btn btn-xs btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                                    </a>
                                                </td>
        ...
        <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
           <script  type="text/javascript">
                  var page ='<?php echo $sponsors->currentPage() ?>';
           </script>
