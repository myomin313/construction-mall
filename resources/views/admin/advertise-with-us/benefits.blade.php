    ...
    <div class="data-table-area  mg-t-10">
                                ...
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="false" data-show-refresh="false" data-key-events="true" data-show-toggle="false" data-resizable="true" data-cookie="true"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td></td>
                                                 <td>{{ ($benefits->currentPage()-1) * $benefits->perPage() + $loop->index + 1 }}</td>
                                                 <td><img src="{{ asset('storage/setting/'.$benefit->img) }}" alt="" title="" ></td>
                                                <td><?= $benefit->title ?></td>
                                                <td><?= $benefit->description ?></td>
                                                <td>
                                                    <a href="{{ route('advertise-with-us.benefit.edit',['id'=>$benefit->id])}}" class="btn btn-xs btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                                    </a>
                                                </td>
          ...
          <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
           <script  type="text/javascript">
                  var page ='<?php echo $benefits->currentPage() ?>';
           </script>
