                                    ...
                                    @include('admin.element.success-message')
                                                          ...
                                                          <div class="form-group">
                                                              <label>Button Text</label>
                                                                <input type="text" class="form-control" placeholder="Button Text" value="{{ old('btn_text',$advertisewithus->btn_text)}}" name="btn_text">
                                                          </div>
          ...
          $(document).ready(function(){
            ...
            //end image upload
             ...
             $('form#advertisewithusUpdate').on('submit',function(e){
               ...
               $.ajax({
                      type: "post",
                      url: "{{ URL::route('advertise-with-us.update',$advertisewithus->id) }}",
