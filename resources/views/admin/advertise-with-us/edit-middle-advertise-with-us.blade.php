                        ...
                        <div class="product-payment-inner-st">
                            ...
                            <div id="myTabContent" class="tab-content custom-product-edit">
                              ...
                              <!--   <div class="product-tab-list tab-pane fade pb-150" id="account"> -->
                                ...
                                <form action="{{ url('/advertise-with-us/middle/update') }}"  method="post" enctype="multipart/form-data">
                                                            {{csrf_field()}}
                                                           
                                                              <div class="form-group">
                                                             
                                                                <input type="text" class="form-control"  value="{{ old('benefit_header',$advertisewithusheader->benefit_header )}}" name="benefit_header">
                                                            </div>

                                                             <div class="form-group">
                                                              
                                                              <textarea name="benefit_bradcrumb"  class="form-control" value="{{ old('benefit_bradcrumb',$advertisewithusheader->benefit_bradcrumb )}}">
                                                    {{ old('benefit_bradcrumb',$advertisewithusheader->benefit_bradcrumb )}}
                                                              </textarea>  
                                                           </div>
