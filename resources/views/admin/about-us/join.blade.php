    ...
    <div class="data-table-area  mg-t-10">
                                ...
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="false" data-show-refresh="false" data-key-events="true" data-show-toggle="false" data-resizable="true" data-cookie="true"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td></td>
                                                <td>{{ ($joins->currentPage()-1) * $joins->perPage() + $loop->index + 1 }}</td>
                                                <td><img src="{{ asset('storage/setting/'.$join->image) }}" alt="" title=""></td>
                                                <td><?= $join->title ?></td>
                                                <td><?= $join->description ?></td>
                                                <td><?= $join->btn_text ?></td>
                                                <td>
                                                    <a href="{{ route('about-us.edit',['id'=>$join->id])}}" class="btn btn-xs btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                                    </a>
                                                </td>
        ...
        <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
           <script  type="text/javascript">
                  var page ='<?php echo $joins->currentPage() ?>';
           </script>
