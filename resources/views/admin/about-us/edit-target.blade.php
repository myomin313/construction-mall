...
@section('content')
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            ...
                            <!--    <li class="active"><a href="#profile">update About With Us</a></li>-->
                            <!--</ul>-->
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div class="row">
                                                  ...
                                                  <div class="form-group">
                                                         <label>Image</label>
                                                                <button type="button" data-dismiss="modal" aria-label="Close" class="btn btn-primary" data-toggle="modal" data-target="#targetaboutusmodal">Upload Photo</button>
        ...
        <!--image upload-modal start-->
            <div class="modal fade bs-example-modal-md-1" id="targetaboutusmodal" tabindex="-1" role="dialog">
               ...
               $.ajax({
                      ...
                      success:function(data)
                      {
                          if($.isEmptyObject(data.errors)){
                              console.log(data);
                            window.location.href = '<?php echo route('about-us.target'); ?>';
                          }
                          else{
