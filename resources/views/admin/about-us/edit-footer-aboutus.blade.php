                        ...
                        <div class="product-payment-inner-st">
                            ...
                            <div id="myTabContent" class="tab-content custom-product-edit">
                              ...
                              <!--   <div class="product-tab-list tab-pane fade pb-150" id="account"> -->
                                ...
                                <form action="{{ url('/about-us/footer/update') }}"  method="post" enctype="multipart/form-data">
                                                            {{csrf_field()}}
                                                            <div class="form-group">
                                                              
                                                                <input type="text" class="form-control" value="{{ old('ready_to_get_start',$aboutusheader->ready_to_get_start)}}" name="ready_to_get_start">
                                                            </div>
                                                            
                                                            <div class="form-group">
                                                             
                                            <input type="text" class="form-control"  value="{{ old('sign_up_today',$aboutusheader->sign_up_today )}}" name="sign_up_today">
                                                            </div>
                                                            
                                                            <div class="form-group">
               <label for="name">Footer Background Color:</label>
               <input type="color" class="form-control"  name="footer_background_color" value="{{ $aboutusheader->footer_background_color }}">
            </div>
                                        <div class="form-group">
                                           <label for="name">Footer Font Color:</label>
                                           <input type="color" class="form-control"  name="footer_font_color" value="{{ $aboutusheader->footer_font_color }}">
                                        </div>     
                                                            <div class="row">
                                                    <div class="col-lg-12">
