  ...
  <section class="inner-wrap supplier_detail"> 
    ...
    <div class="container">
      ...
      <ul class="blog-grid">
        ...
        <!--                  <li><a href="service_list.html">Received Quote</a></li>-->
        <!--                  <li><a href="service_list.html">Requested Quote</a></li>-->
        <!--                </ul>-->
        <!--              </li>-->
        <!--              <li class="dropdown submenu">-->
        <!--                <a href="#" class="dropdown-toggle" data-toggle="dropdown"  aria-haspopup="true" aria-expanded="false-->
        <!--                ">Coin Management</a>-->
        <!--                <ul class="dropdown-menu">-->
        <!--                  <li><a href="service_list.html">Order Coin</a></li>-->
        <!--                  <li><a href="service_list.html">Ordered Coin History</a></li>-->
        <!--                </ul>-->
        <!--              </li>-->
        <!--              <li class="dropdown submenu">-->
        <!--                <a href="#" class="dropdown-toggle" data-toggle="dropdown"  aria-haspopup="true" aria-expanded="false-->
        ...
        <!--                <ul class="dropdown-menu">-->
        <!--                  <li><a href="service_list.html">Project List</a></li>-->
        <!--                  <li><a href="service_list.html">Project Add</a></li>-->
        <!--                </ul>-->
        <!--              </li>-->
        <!--              <li class="dropdown submenu">-->
        <!--                <a href="#" class="dropdown-toggle" data-toggle="dropdown"  aria-haspopup="true" aria-expanded="false-->
        ...
        <!--                  <li><a href="service_list.html">Service Add</a></li>-->
        <!--                </ul>-->
        <!--              </li>-->
                ...
                <div class="col-md-4 col-sm-4">
                   ...
                   <!-- <i class="fa fa-camera" style="color:white;padding:10px;background: #ffcc32;border-radius: 20px" aria-hidden="true"></i></label>-->
                    ...
                    @if(auth()->user()->logo != null)
                                    ...
                                    <img  class="img-responsive logo" src="{{asset('storage/company_logo/'.Auth::user()->logo)}}" alt="" />
                                     <label   class="pull-right logo_upload" for="image_file">
                                     <i class="fa fa-camera" style="color:white;padding:10px;background: #ffcc32;border-radius: 20px" aria-hidden="true"></i></label>
                                     @else
                                     <input type="file" id="image_file" name="profile_photo" accept="image/*" class="hide">
                         ...
                         <img src="{{ asset('storage/company_logo/'.$projectsetting->service_default_logo) }}" class="img-responsive logo" alt="update company logo"
                          >
                          @elseif(Session::get('parent_category_id') == 2)
                          <img src="{{ asset('storage/company_logo/'.$projectsetting->supplier_default_logo) }}" class="img-responsive logo" alt="update company logo"
                         >
                          @elseif(Session::get('parent_category_id') == 3)
                          <img src="{{ asset('storage/company_logo/'.$projectsetting->reno_default_logo) }}" class="img-responsive logo" alt="update company logo"
                          >
                          @endif
            ...
            <div class="row our_services">
              ...
              <div class="col-md-4 col-sm-6">
                <div class="service_list">
                  ...
                  <h5><input name="company_productid" type="checkbox" data-id="{{ $company_product->id }}" value="{{ $company_product->id }}"> <?= $company_product->product_name ?></h5>
                </div>
              </div>
              @php $count +=1 @endphp
              @endforeach
        ...
        <form class="company-profile-form"  id="basicForm" enctype="multipart/form-data">
         ...
         <div class="row">
           ...
           <div class="row">
            ...
            <div class="row">
             <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
              ...
              <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                 ...
                 <input type="text" class="form-control" name="website" placeholder="Eg.https://myanbox.com.mm" value="<?= $company->website?>" id="website">
            ...
            <div class="row">
                <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                   ...
                   <input type="text" class="form-control" placeholder="Eg.https://facebook.com" value="<?= $company->facebook ?>" name="facebook" id="facebook">
                   <div id="facebookError" class="error"></div>
               </div>
               <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <label for="Twitter Link">Twitter Link:</label>
                   <input type="text" class="form-control" placeholder="Eg.https://twitter.com" value="<?= $company->twitter ?>" name="twitter" id="twitter">
           ...
           <div class="row">
                <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                 <label for="Google Plus Link">Google Plus Link:</label>
                   <input type="text" class="form-control" placeholder="Eg.https://myaccount.google.com/profile?" value="<?= $company->googleplus ?>" name="googleplus" id="googleplus">
                   <div id="googleplusError" class="error"></div>
               </div>
               <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <label for="linkedin">Linkedin Link:</label>
                   <input type="text" class="form-control" placeholder="Eg.https://www.linkedin.com/in/yourname" value="<?= $company->linkedin ?>" name="linkedin" id="linkedin">
           ...
           <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
              ...
              <textarea name="service" id="service" class="summernote" value="<?= $company->service ?>">
                  <?= $company->service ?>
              </textarea>
            </div>
            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <label for="vission">Vission:</label>
              <textarea name="vission" id="vission" class="summernote" value="<?= $company->vission ?>">
                  <?= $company->vission ?>
              </textarea>
            </div>
            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
