                ...
                <h4 class="card-title ">
                  <div class="row">
                     <div class="col-sm-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                        <h3 class="panel-title">Update Currency Unit</h3>
                    </div>
...
<div class="card-body">
         ...
         <form  action="{{ route('currency-unit.update',$currency_unit->id) }}" method="post">
          {{csrf_field()}}
          @method('PUT')
          <div class="row">
            <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
              ...
              <div class="form-group">
               ...
               <input type="text" class="form-control {{ $errors->has('currency_name') ? 'error-messageborder' : '' }}" placeholder="Eg. Myanmar Kyat" name="currency_name" value="{{$currency_unit->currency_name}}" >
                <!-- Error -->
            ...
            <!-- End Error -->
              ...
              <div class="form-group">
               ...
               <input type="text" class="form-control {{ $errors->has('unit') ? 'error-messageborder' : '' }}" placeholder="Eg. MMK" name="unit" value="{{$currency_unit->unit}}" >
               <!-- Error -->
                @if ($errors->has('unit'))
                <div class="error">
                    {{ $errors->first('unit') }}
