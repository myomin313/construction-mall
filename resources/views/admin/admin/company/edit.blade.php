                               ...
                               <div class="product-tab-list tab-pane fade active in" id="basic">
                                 ...
                                 @foreach($townships as $township)
                                        @if($company_city->id == $township->parent_id)
                                            @php $selected = ""; @endphp
                                            @if($company->location_id == $township->id)
                                    ...
                                    @endforeach
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                <center>
                                                                    <button class="btn btn-primary waves-effect waves-light" type="submit" id="basic_add_btn" >Update</button>
                                                                </center>
...
<!--image upload-modal end-->
        ...
        <script src="{{ asset('admin/js/jquery-2.1.4.min.js')}}"></script>@include('backend.element.company_basic_profile_script');
