                ...
                <h4 class="card-title ">
                  <div class="row">
                     <div class="col-sm-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                        <h3 class="panel-title">Change {{ $company->user->name }} Company Project</h3>
                    </div>
                     <div class="col-sm-4 col-lg-4 col-md-4 col-sm-4 col-xs-4">
                         @php
                                ...
                                @endphp
                                 <a href="{{ url('/admin/company-project',['company_id'=>$companyid],'?page='.Session::get('pageno')) }}" class="btn btn-default pull-right"><i class="fa fa-list" aria-hidden="true"></i>
                            Project List
                          </a>
                        <!-- <a href="{{ url('/admin/company-project/'.$company_project->company_id.'?page='.Session::get('pageno')) }}" class="btn btn-default pull-right"><i class="fa fa-list" aria-hidden="true"></i>
                            Project List
                          </a>-->
                    </div>   
                  </div>
                  ...
                  <div class="col-lg-12 col-md-12">
                    ...
                    <div class="form-group">
                       <div id="add_more_field">
                          <div class="col-md-offset-11 col-md-1 pb-15">
              ...
              <div class="modal-dialog modal-md" role="document">
                <div class="modal-content">
                  <div class="top_links"><a href="#" data-dismiss="modal" aria-label="Close">Close (X)</a></div>
                     ...
                     <center>
                      <button  data-toggle="modal" data-target=".bs-example-modal-md" class="btn btn-primary mb-20 upload-image_{{$count}}" id="upload-image_{{$count}}" data-dismiss="modal" aria-label="Close">Upload Image</button>
                    </center>
                  </div>
                </div>
      </div>
...
<script type="text/javascript">
 ...
 function addField(label,value)
  {
      $("#add_more_field").append('<div class="row meta-field"><div class="col-md-6"><div class="form-group"><input class="form-control" placeholder="Photo Name" id="photoname_'+value+'" type="text" name="photoname" value="'+label+'"><div id="photo_name_error_'+value+'" class="error"></div></div></div><div class="col-md-5"><a href="#" class="add-modal btn btn-success" data-no="'+value+'">Upload Photo</a><div id="current_cover_photo_'+value+'"></div><div id="current_photo_error_'+value+'" class="error"></div></div><div class="col-md-1"><a href="#" class="add_more_close btn btn-danger">X</a></div></div><div   data-backdrop="" class="modal fade bs-example-modal-md-'+value+'" tabindex="-1" role="dialog" id="addModal'+value+'"><div class="modal-dialog modal-md" role="document"><div class="modal-content"><div class="top_links"><a href="#" data-dismiss="modal" aria-label="Close">Close (X)</a></div><form id="coverphotoForm"><div class="form-group"><center><input type="file" id="image_file_'+value+'" name="cover_photo[]" class="image_file'+value+'"></center><div id="cover_photo_'+value+'" class="cover_photo"></div></div> </form><div class="row" style="padding:20px"><div class="col-lg-12"><center><button  data-toggle="modal" data-target="#addModal'+value+'" class="btn btn-primary btn-block upload-image" id="upload-image_'+
        value+'" data-dismiss="modal" aria-label="Close">Upload Image</button></div></div></center></div></div></div>');
  }
  ...
  $(document).on('click', '.add-modal', function() {
          ...
          $('form#editProjectForm').on('submit',function(e){
              ...
              $.ajax({
                     type: "post",
                     url: "{{ URL::route('admin.project.update',$company_project->id) }}",
                     ...
                     success:function(data)
                     {
                         if($.isEmptyObject(data.photo_errors) && $.isEmptyObject(data.input_errors)){
                            ...
                            var url = "{{ url('/admin/company-project/'.$companyid.'?page='.Session::get('pageno')) }}";
                                 window.location = url;
