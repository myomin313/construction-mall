...
<div class="content">
                ...
                <h4 class="card-title">
                  <div class="row">
                     <div class="col-sm-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                        <h3 class="panel-title">New {{ $company->user->name }} Company Project</h3>
                    </div>
                           ...
                           <div id="add_more_field">
                            ...
                            <div class="row">
                               <div class="col-md-offset-11 col-md-1 pb-15">
                                  <a class="btn btn-success btn-sm pull-right" id="add_more" href="#" > <span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span> Add </a>
                                </div>
                            </div>
                            <div class="row meta-field">
                              ...
                              <!--<div class="col-md-2">-->
                              <!--  <a href="#" class="add_more_close btn btn-danger btn-sm pull-right"><span class="glyphicon glyphicon-minus-sign" aria-hidden="true"></span> Remove</a>-->
                              <!--</div>-->
                            </div>
                          </div>
                           </div>
      ...
      <div class="modal fade bs-example-modal-md-1" tabindex="-1" role="dialog" id="addModalProject">
