                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              <input class="form-control" id="photoname_{{$count}}" name="photoname" value="<?= $photo->image_title ?>" type="text">
                               <div id="photonameError" class="error"></div>
                            </div>
                          </div>
                          <div class="col-md-6">
                ...
                <div class="modal-content">
                  <div class="top_links"><a href="#" data-dismiss="modal" aria-label="Close">Close (X)</a></div>
                     <form id="coverphotoForm">
                       <div class="form-group">
                            <center>
                              <input type="file" id="image_file_{{$count}}" name="cover_photo[]" class="image_file">
                            </center>
                            ...
                            console.log(data.errors); 
                             if($.isEmptyObject(data.errors.name)){ 
                               ...
                               if($.isEmptyObject(data.errors.project_type)){ 
                                ...
                                if($.isEmptyObject(data.errors.photo_arr)){ 
                                  $('#photonameError').html("");
                                   $("input[name=photoname]").removeClass('error-messageborder');
                              }else{
                                   $('#photonameError').html(data.errors.photo_arr);
                                   $("input[name=photoname]").addClass('error-messageborder');
                              }
                         } 
