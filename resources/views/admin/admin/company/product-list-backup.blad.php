                        ...
                        <h4 class="card-title ">
                          <div class="row">
                             <div class="col-sm-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                <h3 class="panel-title">{{ $company->user->name }}'s Products</h3>
                            </div>
                        ...
                        <div class="sparkline13-list">
                          ...
                          $name ="";
                                    ...
                                    <div class="col-md-12">
                                       ...
                                       <a  type="button" href="{{url('admin/product/create/'.$id)}}"  class="btn btn-success editeducationBtn"><i class="fa fa-plus" aria-hidden="true"></i> Create New</a>
                                    </div>
                                   </div>
