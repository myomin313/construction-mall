                ...
                <h4 class="card-title ">
                  <div class="row">
                     <div class="col-sm-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                        <h3 class="panel-title">Add New Coin Plan</h3>
                    </div>
                     <div class="col-sm-4 col-lg-4 col-md-4 col-sm-4 col-xs-4">
                        <a href="{{ route('admin.coinplan.index') }}" class="btn btn-default pull-right"><i class="fa fa-list" aria-hidden="true"></i>
                             Coin Plan List
                          </a>
                    </div>   
                  </div>
    ...
    <div class="card-body">
     ...
     <!--<div class="panel panel-default col-lg-offset-1 col-md-offset-1 col-md-10 col-lg-10">-->
       <!--<div class="panel-body">-->
         <form  id="editServiceForm" action="{{ route('coinplan.store') }}" method="post" enctype="multipart/form-data">
          {{csrf_field()}}
          <div class="row">
            <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
              ...
              <div class="form-group">
               ...
               <input type="number" class="form-control {{ $errors->has('coin_count') ? 'error-messageborder' : '' }}" placeholder="Coin Count" name="coin_count" value="{{ old('coin_count') }}">
               <!-- Error -->
