...
@section('content')
                ...
                <h4 class="card-title ">
                  <div class="row">
                     <div class="col-sm-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                        <h3 class="panel-title">Update privacy</h3>
                    </div>
                     <div class="col-sm-4 col-lg-4 col-md-4 col-sm-4 col-xs-4">
                        <a href="{{ route('privacy') }}" class="btn btn-default pull-right">
                                                          ...
                                                          <form action="{{ route('privacy.update') }}"  method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group">
                                                              <label>Title</label><span class="text-error-danger"> * </span>
                                                                <input type="text" class="form-control {{ $errors->has('privacy_header') ? 'error-messageborder' : '' }}" placeholder="Title" value="{{ old('privacy_header',$privacy->privacy_header)}}" name="privacy_header">
                                                                 <!-- Error -->
                                                                    @if ($errors->has('privacy_header'))
                                                                    <div class="error">
                                                                        {{ $errors->first('privacy_header') }}
                                                                    </div>
                                                                    @endif
                                                                <!-- End Error -->
                                                            </div>
                              ...
                              <!--<input type="file" name="imageUpload" id="imageUpload" class="hide" />-->
                                  <!--<input type="file" id="blog_file" name="blog_photo" accept="image/*" class="hide">-->
                                                             ...
                                                             <div class="form-group">
                                                              ...
                                                              <textarea name="privacy" id="privacy" class="summernote" >
    ...
    <script type="text/javascript">
          $(document).ready(function(){
             ...
             // start
              var img = '<?php echo asset('storage/setting/'.$privacy->header_image) ?>';
              var image_name = '<?php echo $privacy->header_image ?>';   
            ...
            $('.upload-privacy-image').on('click', function (ev) {
              resize.croppie('result', {
                ...
                size: 'viewport'
                 ...
                 $.ajax({
                   url: "{{ route('privacy.croppie.upload-blog-image') }}",
                   type: "POST",
