  ...
  <div class="content">
      <div class="container-fluid">
        <div class="row">
          ...
          <form class="form-inline" action="{{ route($path_name,1) }}" method="get">
                          {{csrf_field()}}
                       ...
                       <div class="form-group col-md-3 col-sm-6 col-xs-12">
                         <label>Email : </label>
                          <input value="{{$email}}" type="text" class="form-control" name="email" placeholder="Eg.aung@gmail.com">
                      </div>
                       <div class="form-group col-md-2 col-sm-6 col-xs-12">
                          <label>Phone : </label>
                          <input value="{{$phone}}" type="text" class="form-control" name="phone" placeholder="Eg.094203399">
                       </div>
                     ...
                     <div class="col-sm-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                      ...
                      <div class="col-sm-4 col-lg-4 col-md-4 col-sm-4 col-xs-4">
                       @if(strcmp($user,"Admin") == 0)
                           <a  type="button" href="{{route('users.createadmin')}}"  class="btn btn-default pull-right editeducationBtn"><i class="fa fa-plus" aria-hidden="true"></i> Create New</a>
                         @endif
                     </div>
                   </div>
                </h4>
                     ...
                     data-click-to-select="true" data-toolbar="#toolbar">
                                  <thead>
                                      <tr>
                                          ...
                                          @if(strcmp($user,"Member") == 0 || strcmp($user,"Freelancer") == 0)
                                          <th data-field="email_verified_flag" data-editable="true">Email Verified</th>
                                          @endif
                                  ...
                                  @foreach($lists as $list)
                                      ...
                                      <tr>
                                           ...
                                           <td>
                                            ...
                                            @if(strcmp($user,'Freelancer') == 0)
                                              @php
                                                     ...
                                                     @endphp
                                            <a href="{{ route('admin.freelancer.detail',$id) }}"><?= $list->name ?></a> 
                                            @else
                                             @php
                                                        $id = $list->id;
                                                        $id = \Crypt::encrypt($id);
                                          ...
                                          <td><?= $list->phone ?></td>
                                          <td>
                                            <select id="{{$list->id}}" name="is_active" data-control="status" class="form-control status_change">
                                            <option value="1" <?= ($list->is_active==1)?"selected":""?>>Active</option>
                                            <option value="0" <?= ($list->is_active==0)?"selected":""?>>Inactive</option>
                                        </select>
                                          </td>
                                           @if($list->role== 1 || $list->role== 3)
                                          <td><?= $list->email_verified_flag=='0'?'<i class="fa fa-window-close-o" style="color:red" ></i>
