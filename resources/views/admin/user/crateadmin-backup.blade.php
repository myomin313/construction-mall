                     ...
                     <div id="error"></div>  
                        ...
                        <div class="col-lg-6 col-md-6">
                          ...
                          <div class="form-group">
                            ...
                            <input type="password" name="confirm" placeholder="Confirm Password" class="form-control" id="confirmpassword">
                     ...
                     success:function(data)
                     {
                         if($.isEmptyObject(data.errors)){
                              ...
                              var message = data.success;
                                var url = "{{ route('users.adminlist',1) }}";
                             ...
                             console.log(data.errors);
                              ...
                              if($.isEmptyObject(data.errors.confirm)){ 
                                  $('#confirmError').html("");
                                  $("input[name=confirm]").removeClass('error-messageborder');
                              }else{
                                  $('#confirmError').html(data.errors.confirm);
                                  $("input[name=confirm]").addClass('error-messageborder');
                              }
