                                ...
                                if(($freelancer_city)){
                                    $freelancer_city_id = $freelancer_city->id;
                                        ...
                                        if($township->parent_id == $freelancer_city_id){                                                                           if($township->id == $freelancer->location_id)
                                                               ...
                                                               <textarea name="description" id="freelancer_description" class="summernote" style="background-color: #F5F5F5 !important">
                                                    ...
                                                    <div class="form-group"> 
                                                            ...
                                                            <div class="form-group"> 
                                                             ...
                                                             <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control edit_project_start_date_modal" name="project_start_date" id="project_start_date" placeholder="eg.2021-07-08" value=""> 
                                                                <div id="edit_project_start_date_modalError" class="error"></div>
                                                            </div>

                                                            <div class="form-group">
                                                                <label>Project End Date</label><span class="text-error-danger"> * </span>
                                                        <input type="text" class="form-control edit_project_end_date_modal" name="project_end_date" placeholder="eg.2021-07-08" id="project_end_date" value="">
                                                        ...
                                                        <div class="col-lg-6 col-md-6">
                                                            <div class="form-group">
                                                              ...
                                                              <textarea name="project_detail" class="summernote edit_project_detail_modal" id="edit_project_detail">
                     ...
                     <div class="row">
                                                ...
                                                <div class="form-group"> 
                                                        ...
                                                        <div class="col-lg-6 col-md-6">
                                                            <div class="form-group">
                                                                <label>From</label><span class="text-error-danger"> * </span>
                                                                <input type="month" class="form-control edit_from_date_modalEducation" name="from_date" id="education_from_date" placeholder="Eg.2020-01" value="" style="border-radius:0px"> 
                                                        ...
                                                        <div class="col-lg-6 col-md-6">
                                                            <div class="form-group">
                                                                <label>To</label><span class="text-error-danger"> * </span>
                                                                  <input type="month" class="form-control edit_to_date_modalEducation" name="to_date" id="education_to_date" placeholder="Eg.2020-01" value="" style="border-radius:0px">
                                                    ...
                                                    <div class="col-lg-12 col-md-12">                           
                                                         <form id="projectForm" class="freelancer-profile-form">
                                                            ...
                                                            <div class="form-group"> 
                                                             ...
                                                             <div class="form-group">
                                                                <label>Project Start Date</label><span class="text-error-danger">*</span>
                                                                <input type="text" id="project_start_date_edit" class="form-control edit_project_start_date_pro" name="project_start_date" placeholder="eg.2021-07-08" value=""> 
                                                                 <div id="edit_project_start_date_proError" class="error"></div>
                                                            </div>

                                                            <div class="form-group">
                                                                <label>Project End Date</label><span class="text-error-danger"> * </span>
                                                        <input type="text" id="project_end_date_edit" class="form-control edit_project_end_date_pro" name="project_end_date" placeholder="eg.2021-07-08" value="">
                                                        ...
                                                        <div class="col-lg-6 col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                <label>Description</label><span class="text-error-danger"> * </span>
                                                              <textarea
                                                              class="summernote edit_project_detail_pro" name="project_detail" id="project_detail">
                                                              </textarea> 
...
<script>
  $( function() {
    ...
    $("#project_start_date_edit").datepicker({
                ...
                onSelect: function (date) {
                   //Get selected date 
                    var date2 = $('#project_start_date_edit').datepicker('getDate');
                    //sets minDate to txt_date_to
                    $('#project_end_date_edit').datepicker('option', 'minDate', date2);
                }
            });
            $('#project_end_date_edit').datepicker({
                dateFormat: "yy-mm-dd",
...
var month=date.getMonth();
	...
	$("#from_dateExperience").monthpicker({
  Button: false,
  dateFormat: "yy-mm",
  autoclose: true,
  onSelect: function(text, inst) {
   ...
   // var maxDate = new Date(inst.selectedYear, inst.selectedMonth + 3, 1);
    $('#to_dateExperience').monthpicker('option', 'minDate', minDate);
  //  $('#to_dateExperience').monthpicker('option', 'maxDate', maxDate);
  }
});
$('#to_dateExperience').monthpicker({
  Button: false,
  dateFormat: "yy-mm",
  autoclose: true,
  onSelect: function(text, inst) {
...
$("#from_date").monthpicker({
  ...
  onSelect: function(text, inst) {
    var minDate = new Date(inst.selectedYear, inst.selectedMonth + 1, 1);
  //  var maxDate = new Date(inst.selectedYear, inst.selectedMonth + 3, 1);
    $('#to_date').monthpicker('option', 'minDate', minDate);
   // $('#to_date').monthpicker('option', 'maxDate', maxDate);
  }
});
$('#to_date').monthpicker({
  Button: false,
  ...
  onSelect: function(text, inst) {
	...
	$("#fromdate_education").monthpicker({
  Button: false,
  dateFormat: "yy-mm",
  autoclose: true,
  onSelect: function(text, inst) {
    var minDate = new Date(inst.selectedYear, inst.selectedMonth + 1, 1);
   // var maxDate = new Date(inst.selectedYear, inst.selectedMonth + 3, 1);
    $('#todate_education').monthpicker('option', 'minDate', minDate);
  //  $('#to_dateExperience').monthpicker('option', 'maxDate', maxDate);
  }
});
$('#todate_education').monthpicker({
  Button: false,
  dateFormat: "yy-mm",
  autoclose: true,
  onSelect: function(text, inst) {
...
$("#education_from_date").monthpicker({
  Button: false,
  dateFormat: "yy-mm",
  autoclose: true,
  endDate: "2021-08",
  onSelect: function(text, inst) {
    var minDate = new Date(inst.selectedYear, inst.selectedMonth + 1, 1);
  //  var maxDate = new Date(inst.selectedYear, inst.selectedMonth + 3, 1);
    $('#education_to_date').monthpicker('option', 'minDate', minDate);
   // $('#to_date').monthpicker('option', 'maxDate', maxDate);
  }
});
$('#education_to_date').monthpicker({
  Button: false,
  dateFormat: "yy-mm",
  autoclose: true,
  onSelect: function(text, inst) {
