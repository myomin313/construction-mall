  ...
  <div class="container-fluid">
    <div class="row"> 
        ...
        <div class="card">
                ...
                <h4 class="card-title ">
                  <div class="row">
                     <div class="col-sm-8 col-lg-8 col-md-8 col-sm-8 col-xs-8">
                        <h3 class="panel-title">Change Company Category Information</h3>
                    </div>
                     <div class="col-sm-4 col-lg-4 col-md-4 col-sm-4 col-xs-4">
                        <a href="{{ url('companycategory/index?page='.Session::get('pageno')) }}" class="btn btn-default pull-right"><i class="fa fa-list" aria-hidden="true"></i>
             ...
             <form  id="editServiceForm" action="{{ route('companycategory.update',$category->id) }}" method="post" enctype="multipart/form-data">
              {{csrf_field()}}
              <div class="row">
                <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" name="parent_id" style="margin:10px 0px !important">
                      @foreach($company_catgories as $company_category)
                    ...
                    <input type="text" class="form-control {{ $errors->has('name') ? 'error-messageborder' : '' }}" placeholder="Name" name="category_name" value="<?= $category->name ?>">
                      <!-- Error -->
