                       ...
                       <div class="col-md-12 ">
                          <div class="list-group">
                            @foreach($data as $company)
                             @if($type =='Service')
                              <a href="{{ url('servicecompanydetail/'.$company->company_url )}}" class="list-group-item">
                              @elseif($type=='Supplier')
                               <a href="{{ url('suppliercompanydetail/'.$company->company_url )}}" class="list-group-item">
                              @else
                                <a href="{{ url('renobusinessdetail/'.$company->company_url )}}" class="list-group-item">
                              @endif
                              <div class="row">
