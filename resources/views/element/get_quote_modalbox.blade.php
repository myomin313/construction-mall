            ...
            <form class="login-form" id="next" enctype="multipart/form-data">
                ...
                <fieldset>
                    <div class="form-group">
                        ...
                        <label>
                            <input type="radio" name="category_id" class ="company_category_id" value="1" checked id="service_category">  <span class="project_type_label">Service</span>
                        </label>
                        <label>
                            <input type="radio" name="category_id" class ="company_category_id" value="2" id="supplier_category">  <span class="project_type_label">Supplier</span>
                        </label>
                        <label>
                            <input type="radio" name="category_id" class ="company_category_id" value="3" id="reno_category">  <span class="project_type_label">Reno Busines</span>
                        </label>
                    </div>
                    ...
                    <div class="supplier_category" style="display: none;">
                        @foreach($supplierCategories as $supplier_category)
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <label>
                                    <input class="company_subcategory_id" id="subcategory_id_{{$supplier_category->id}}" type="checkbox" name="subcategory_id[]" value="{{$supplier_category->id}}">  <span>
                                    {{$supplier_category->name}}</span>
                                </label>
                            </div>
                        @endforeach
                    </div>
                    <div class="reno_category" style="display: none;">
                        @foreach($renobusinessCategories as $reno_category)
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <label>
                                    <input class="company_subcategory_id" 
                                id="subcategory_id_{{$reno_category->id}}" type="checkbox" name="subcategory_id[]" value="{{$reno_category->id}}">  <span>
                                   {{$reno_category->name}}</span>
                                </label>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" name="project_expected_start_date" class="form-control" min="<?php echo date("Y-m-d"); ?>" id="project_expected_start_date" placeholder="project expected start date">
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                ...
                                <select class="form-control" name="city" id="quote_city">
                            ...
                            <div class="col-md-6 col-sm-6">
                                ...
                                <select class="form-control" name="township" id="quote_township">
