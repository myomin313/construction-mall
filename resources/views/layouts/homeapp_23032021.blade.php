...
<div class="modal fade bs-example-modal-md-2" tabindex="-1" role="dialog" id="get_quote">
  <div class="modal-dialog modal-md-2" role="document">
    <div class="modal-content">
      ...
      <form class="login-form" id="next" method="post" enctype="multipart/form-data">
        {{csrf_field()}}
        <fieldset>
          <div class="form-group">
            <label>Project Type :</label>
            <input type="radio" name="category_id" id="company_category_id" value="1" checked>  <span>Service</span>
            <input type="radio" name="category_id" id="company_category_id" value="2">  <span>Supplier</span>
            <input type="radio" name="category_id" id="company_category_id" value="3">  <span>Reno Business</span>
            </div>
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            ...
            <textarea  rows="4" cols="50" name="project_information" class="form-control" id="project_information" placeholder="Please Ener Project Information" style="resize: none;"></textarea>
         ...
         <div class="form-group" id="add_more_field">
            ...
            <div class="row meta-field">
              ...
              <div class="col-md-1">
                <div class="bordered">
                   <a id="add_more" class="pull-right"  href="#" ><i class="fa fa-plus" aria-hidden="true"></i>
                    </a>
                </div>
              </div>
            </div>
        ...
        <div class="form-group" id="add_more_field1">
            ...
            <div class="row meta-field1">
              ...
              <div class="col-md-1">
                <a id="add_more1" href="#" ><i class="fa fa-plus" aria-hidden="true"></i></a>
              </div>
            </div>
        </div>
       
           <div class="form-group">
              <label>Please Upload Files <small class="file_error">(Allowed file type :doc, docx,pdf,txt.Only one file in a time.)</small></label><br>
              <div class="row">
                <div class="col-md-4">
...
<script src="{{ asset('js/script.js') }}"></script>
 <script type="text/javascript">
  ...
  $("#add_more").click(function(){
      addField('#add_more_field','contact_email','Other Contact Email','email',++email_count);
  ...
  $("#add_more1").click(function(){
      addField('#add_more_field1','contact_phone','Other Contact Phone Number','number',++phone_count);
      $(".add_more_close").click(function(){
              $(this).parents(".meta-field").remove();
              return false;
         });
